    ...
    <div className="container space-y-8 md:space-y-10">
      <div className="rounded-xl border bg-white dark:bg-black dark:border-neutral-800 p-6 md:p-10 shadow-sm">
        ...
        <p className="mt-4 max-w-3xl text-foreground/80">
          <strong>Begusarai CSC</strong> में आपका हार्दिक स्वागत है। यहाँ हम
          Begusarai और आसपास के क्षेत्र के लोगों के लिए डिजिटल सेवाओं और उपयोगी
          ऑनलाइन टूल्स को आसान और सुलभ बनाते हैं। हमारा उद्देश्य CSC ऑपरेटरों और
          आम नागरिकों के रोज़मर्रा के कागजी कार्यों को त��ज़, सरल और भरोसेमंद
          बनाना है।
        </p>
      </div>
      ...
      <div className="grid gap-6 md:grid-cols-3">
        <div className="rounded-lg border bg-white dark:bg-black dark:border-neutral-800 p-6">
          ...
          <ul className="mt-3 space-y-2 text-sm text-foreground/80">
            <li className="flex items-start gap-2">
              ...
              PDF एडिटिंग, कन्वर्ज़न और साइज बदलना (Compress, Convert, Edit)
            </li>
            <li className="flex items-start gap-2">
              <span className="mt-1 inline-block h-1.5 w-1.5 rounded-full bg-primary" />
              PAN / Aadhar संबंधित टूल्स और फॉर्म सपोर्ट
            </li>
            <li className="flex items-start gap-2">
              <span className="mt-1 inline-block h-1.5 w-1.5 rounded-full bg-primary" />
              रिज़्यूमे एडिटिंग, QR कोड जनरेशन और इमेज बैकग्राउंड रिमूवल
            </li>
            <li className="flex items-start gap-2">
              <span className="mt-1 inline-block h-1.5 w-1.5 rounded-full bg-primary" />
              दस्तावेज़ जोड़ना, ��ेज रियरेंज करना आदि
            </li>
          </ul>
        </div>
        ...
        <div className="rounded-lg border bg-white dark:bg-black dark:border-neutral-800 p-6">
          ...
          <ul className="mt-3 space-y-2 text-sm text-foreground/80">
            <li className="flex items-start gap-2">
              ...
              लोकल फोकस — Begusarai समुदाय की ज़रूरतों के लिए बनाया गया
            </li>
            <li className="flex items-start gap-2">
              <span className="mt-1 inline-block h-1.5 w-1.5 rounded-full bg-accent" />
              सहज इंटरफ़ेस — सरल और उपयोग में आसान
            </li>
            <li className="flex items-start gap-2">
              <span className="mt-1 inline-block h-1.5 w-1.5 rounded-full bg-accent" />
              तेज़ समाधान — समय बचाने वाले टूल्स
            </li>
            <li className="flex items-start gap-2">
              <span className="mt-1 inline-block h-1.5 w-1.5 rounded-full bg-accent" />
              भरोसेमंद — CSC ऑपरेटरों की आवश्यकताओं के अनुरूप
            </li>
          </ul>
        </div>
        ...
        <div className="rounded-lg border bg-white dark:bg-black dark:border-neutral-800 p-6">
          ...
          <p className="mt-3 text-sm text-foreground/80">
            स्थानीय समुदाय को डिजिटल रूप से स��क्त बनाना — ताकि सरकारी और निजी
            दस्तावेज़ आसानी से, तेज़ और सुरक्षित तरीके से पूरे हो सकें।
          </p>
        </div>
      </div>
        ...
        <div className="flex flex-col items-start justify-between gap-4 sm:flex-row sm:items-center">
          <div>
            <h4 className="text-base font-semibold">
              क्या आप किसी विशेष दस्तावेज़ में मदद चाहते हैं?
            </h4>
            <p className="text-sm text-foreground/70">
              हमसे बात करें या सीधे टूल्स सेक्शन देखें।
            </p>
          </div>
          <div className="flex gap-3">
            <a
              ...
              className="inline-flex items-center rounded-md bg-[#094BF3] lg:bg-foreground px-4 py-2 text-sm font-semibold text-background pointer-events-auto cursor-pointer"
            >
              Contact
            </a>
          </div>
  ...
  <section className="bg-gradient-to-br from-[#283c86] to-[#45a247] text-white py-16">
    <div className="container flex min-h-[70vh] items-center justify-center">
      <div className="w-full max-w-md rounded-2xl bg-black/70 p-8 text-center shadow-xl">
        <h2 className="mb-2 text-2xl font-bold text-[#ffcc00]">
          हमसे संपर्क करें
        </h2>
        ...
        <div className="mt-4 space-y-2 text-sm">
          <p>
            <strong className="text-[#ffcc00]">पता:</strong> पंसल्ला, बेगूसराय,
            बिहार
          </p>
          <p>
            <strong className="text-[#ffcc00]">फोन:</strong>{" "}
            <a
              href="tel:+917520663547"
          ...
          <p>
            ...
            <a
              href="mailto:satya763190@gmail.com"
              className="text-[#ffcc00] underline-offset-2 hover:underline"
            >
