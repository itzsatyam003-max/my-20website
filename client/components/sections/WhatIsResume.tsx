      ...
      <div className="container grid items-center gap-10 md:grid-cols-2">
        <div>
          <h2 className="text-3xl font-bold">
            What is a <span className="text-primary">Resume & CV</span> ?
          </h2>
          <p className="mt-4 text-foreground/80">
            A resume is a document that outlines an individual's work
            experience, education, and skills. It is typically used to apply for
            jobs, internships, and other opportunities and serves as a summary
            of an individual's qualifications and abilities.
          </p>
